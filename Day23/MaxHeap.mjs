export class MaxHeap {
    ...
    heapifyDown(index) {
        ...
        if (!this.isLeaf(index)) {
            ...
            if (this.values[leftChildIndex] && this.values[leftChildIndex].weight > this.values[largestIndex].weight) {
                // reassign largest index to left child index
                largestIndex = leftChildIndex;
            }

            // if the right child > element at largest index (either parent or left child)
            if (this.values[rightChildIndex] && this.values[rightChildIndex].weight >= this.values[largestIndex].weight) {
    ...
    // // Adding The Elements
    // heap.add(createNode(10,0,0,0,0));
    // heap.add(createNode(15,0,0,0,0));
    // heap.add(createNode(30,0,0,0,0));
    // heap.add(createNode(40,0,0,0,0));
    // heap.add(createNode(50,0,0,0,0));
    // heap.add(createNode(100,0,0,0,0));
    // heap.add(createNode(40,0,0,0,0));
